...
RFmodel_1200 <- randomForest(butterfly.abu~., data = train_r1200, 
                                  ntree = 2000)
RFmodel_1200
plot(RFmodel_1200)
ntree_best <- 1000
...
#   mutate(response.var = "abu_total_1200")
# 
# tune_r1200 %>%
#   head(10)
# 
# # save
# tune_r1200 %>%
#   write.xlsx(here("outputs", "models", "cRF", "cRF_mtry", "tune_mtry_abu_total_1200_2026-03-12.xlsx"))

# load 
tune_mtry <- readxl::read_excel(
  here("outputs", "models", "cRF", "cRF_mtry", "tune_mtry_abu_total_1200_2026-03-12.xlsx"))
...
# cf_1200 <- party::cforest(formula = butterfly.abu ~ .,
#                                data    = train_r1200,
#                                controls = cforest_unbiased(ntree = ntree_best,
#                                                            mtry = mtry_best))
# 
# # save model
# saveRDS(cf_1200, here("outputs", "models", "cRF", "cRF_RData", "cf_1200_abu_total_2026-03-12.RData"))

# load model
cf_1200 <- readRDS(here("outputs", "models", "cRF", "cRF_RData", "cf_1200_abu_total_2026-03-12.RData"))
...
"stats_training_abu_total_1200_2026-03-12.xlsx"))
...
pred_RMSE_1200 <- round(sqrt(mean((pred_1200-test_r1200$butterfly.abu)**2)),2)
pred_RMSE_1200
# 41.32
pred_R2_1200 <- round(cor(pred_1200, test_r1200$butterfly.abu)**2,2)
pred_R2_1200
# 0.38
...
#          value = round(value, 2))
# imp_r1200 %>% write.xlsx(here("outputs", "tables", "imp_r1200_abu_total.xlsx"))
