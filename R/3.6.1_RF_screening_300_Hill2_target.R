#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
# GRASSWORKS Project 
# cRF analyses - target Hill-Simpson diversity
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
# author: Line Sturm
# 13 June 2026
...
data_r300 <- data_restored %>%
  dplyr::select(butterfly.Hill2.target,
...
RFmodel_300 <- randomForest(butterfly.Hill2.target~., data = train_r300, 
                                  ntree = 2000)
RFmodel_300
plot(RFmodel_300)
ntree_best <- 1000
...
#   model <- party::cforest(formula = butterfly.Hill2.target~.,
#                           data    = train_r300,
...
#   mutate(response.var = "target_hill2_300")
# 
# tune_r300 %>%
#   head(10)
# 
# # save
# tune_r300 %>%
#   write.xlsx(here("outputs", "models", "cRF", "cRF_mtry", "tune_mtry_Hill2_target_300_2026-03-12.xlsx"))

# load 
tune_mtry <- readxl::read_excel(
  here("outputs", "models", "cRF", "cRF_mtry", "tune_mtry_Hill2_target_300_2026-03-12.xlsx"))
...
plot_tune_mtry_Hill2_target <- tune_mtry %>% 
  ...
  labs(x = "mtry", y = "OOB RSME", 
       subtitle = "best mtry = 13, ntree = 1000",
       title = "(F) Target Hill-Simpson")
print(plot_tune_mtry_Hill2_target)
mtry_best <- 13
...
# cf_300 <- party::cforest(formula = butterfly.Hill2.target ~ .,
#                                data    = train_r300,
#                                controls = cforest_unbiased(ntree = ntree_best,
#                                                            mtry = mtry_best))
# 
# # save model
# saveRDS(cf_300, here("outputs", "models", "cRF", "cRF_RData", "cf_300_Hill2_target_300_2026-03-12.RData"))

# load model
cf_300 <- readRDS(here("outputs", "models", "cRF", "cRF_RData", "cf_300_Hill2_target_300_2026-03-12.RData"))
...
"stats_training_Hill2_target_300_2026-03-12.xlsx"))
...
pred_RMSE_300 <- round(sqrt(mean((pred_300-test_r300$butterfly.Hill2.target)**2)),2)
pred_RMSE_300
# 1.1
pred_R2_300 <- round(cor(pred_300, test_r300$butterfly.Hill2.target)**2,2)
pred_R2_300
# 0.17
...
#          value = round(value, 2))
# imp_r300 %>% write.xlsx(here("outputs", "tables", "imp_r300_Hill2_target.xlsx"))
