...
RFmodel_300 <- randomForest(butterfly.Hill2.total~., data = train_r300, 
                                  ntree = 2000)
RFmodel_300
plot(RFmodel_300)
ntree_best <- 1000
...
#   mutate(response.var = "Hill2_tot_300")
# 
# tune_r300 %>%
#   head(10)
# 
# # save
# tune_r300 %>%
#   write.xlsx(here("outputs", "models", "cRF", "cRF_mtry", "tune_mtry_Hill2_total_300_2026-03-12.xlsx"))

# load 
tune_mtry <- readxl::read_excel(
  here("outputs", "models", "cRF", "cRF_mtry", "tune_mtry_Hill2_total_300_2026-03-12.xlsx"))
...
plot_tune_mtry_Hill2_total <- tune_mtry %>% 
  ...
  labs(x = "mtry", y = "OOB RSME", 
       subtitle = "best mtry = 7, ntree = 1000",
...
# cf_300 <- party::cforest(formula = butterfly.Hill2.total ~ .,
#                                data    = train_r300,
#                                controls = cforest_unbiased(ntree = ntree_best,
#                                                            mtry = mtry_best))
# 
# # save model
# saveRDS(cf_300, here("outputs", "models", "cRF", "cRF_RData", "cf_300_Hill2_total_2026-03-12.RData"))

# load model
cf_300 <- readRDS(here("outputs", "models", "cRF", "cRF_RData", "cf_300_Hill2_total_2026-03-12.RData"))
...
"stats_training_Hill2_total_300_2026-03-12.xlsx"))
...
pred_RMSE_300 <- round(sqrt(mean((pred_300-test_r300$butterfly.Hill2.total)**2)),2)
pred_RMSE_300
# 2.19
pred_R2_300 <- round(cor(pred_300, test_r300$butterfly.Hill2.total)**2,2)
pred_R2_300
# 0.23
...
#          value = round(value, 2))
# imp_r300 %>% write.xlsx(here("outputs", "tables", "imp_r300_Hill2_total.xlsx"))
