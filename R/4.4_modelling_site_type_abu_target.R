#+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
# GRASSWORKS Project 
# Analyses of site type - target abundance
#+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
# author: Line Sturm
# 13 June 2026
...
## 1 glm1 ####
glm1 <- glm(butterfly.target.abu ~ site.type + obs.year + region + site.cwm.pres.oek.f
            + region:obs.year,
...
## 2 glm1a ####
glm1a <- glm(butterfly.target.abu ~ site.type + obs.year + region + site.cwm.pres.oek.f,
            data = data,family = "poisson")
summary(glm1a)
...
## 3 glm1a_nb ####
glm1a_nb <- glm.nb(butterfly.target.abu ~ site.type + region + obs.year + site.cwm.pres.oek.f,
             data = data)
glm1a_nb_summary <- summary(glm1a_nb)
sink(here("outputs", "models", "all_sites", "abu_target",
...
# data:  glm1a_nb
# observed = 0.0064195, expected = -0.0053763, sd = 0.0284009, p-value = 0.6779
# alternative hypothesis: Distance-based autocorrelation


### d) validate model ----------------------------------------------------------
png(here("outputs", "models", "all_sites", "abu_target",
...
plotResiduals(sr_glm1a_nb)   # still ok
dev.off()
plotResiduals(sr_glm1a_nb, data$site.cwm.pres.oek.f)  # ok
plotResiduals(sr_glm1a_nb, data$site.type)            # ok
plotResiduals(sr_glm1a_nb, data$obs.year)             # heteroskedasticity (minor)
plotResiduals(sr_glm1a_nb, data$region)               # ok
...
# R2m       R2c
# delta     0.3379632 0.3379632
# lognormal 0.4153495 0.4153495
# trigamma  0.2476515 0.2476515
...
dat_pred2 %>% write.csv(file = here::here("outputs", "tables", 
                                          "EMM1_site_type_abu_target.csv"), row.names = F)
