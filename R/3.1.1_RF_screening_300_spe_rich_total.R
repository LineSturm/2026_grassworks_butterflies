...
RFmodel_300 <- randomForest(butterfly.rich.total~., data = train_r300, 
                                  ntree = 2000)
RFmodel_300
plot(RFmodel_300)
ntree_best <- 1000
...
#   mutate(response.var = "rich_total_300")
# 
# tune_r300 %>%
#   head(10)
# 
# # save
# tune_r300 %>%
#    write.xlsx(here("outputs", "models", "cRF", "cRF_mtry", "tune_mtry_rich_total_300_2026-03-12.xlsx"))

# load 
tune_mtry <- readxl::read_excel(
  here("outputs", "models", "cRF", "cRF_mtry", "tune_mtry_rich_total_300_2026-03-12.xlsx"))
...
# cf_300 <- party::cforest(formula = butterfly.rich.total ~ .,
#                                data    = train_r300,
#                                controls = cforest_unbiased(ntree = ntree_best,
#                                                            mtry = mtry_best))
#
# # save model
# saveRDS(cf_300, here("outputs", "models", "cRF", "cRF_RData", "cf_300_rich_total_2026-03-12.RData"))

# load model
cf_300 <- readRDS(here("outputs", "models", "cRF", "cRF_RData", "cf_300_rich_total_2026-03-12.RData"))
...
"stats_training_rich_total_300_2026-03-12.xlsx"))
...
pred_RMSE_300 <- round(sqrt(mean((pred_300-test_r300$butterfly.rich.total)**2)),2)
pred_RMSE_300
# 3.94
pred_R2_300 <- round(cor(pred_300, test_r300$butterfly.rich.total)**2,2)
pred_R2_300
# 0.6

plot(pred_300, test_r300$butterfly.rich.total,
     xlab = "Predicted",
     ylab = "Observed")
...
#          value = round(value, 2))
# imp_r300 %>% write.xlsx(here("outputs", "tables", "imp_r300_rich_total.xlsx"))
