...
RFmodel_600 <- randomForest(butterfly.Hill2.total~., data = train_r600, 
                                  ntree = 2000)
RFmodel_600
plot(RFmodel_600)
ntree_best <- 1000
...
#   mutate(response.var = "Hill2_total_600")
# 
# tune_r600 %>%
#   head(10)
# 
# # save
# tune_r600 %>%
#   write.xlsx(here("outputs", "models", "cRF", "cRF_mtry", "tune_mtry_Hill2_total_600_2026-03-12.xlsx"))

# load 
tune_mtry <- readxl::read_excel(
  here("outputs", "models", "cRF", "cRF_mtry", "tune_mtry_Hill2_total_600_2026-03-12.xlsx"))
...
# cf_600 <- party::cforest(formula = butterfly.Hill2.total ~ .,
#                                data    = train_r600,
#                                controls = cforest_unbiased(ntree = ntree_best,
#                                                            mtry = mtry_best))
# 
# # save model
# saveRDS(cf_600, here("outputs", "models", "cRF", "cRF_RData", "cf_600_Hill2_total_2026-03-12.RData"))

# load model
cf_600 <- readRDS(here("outputs", "models", "cRF", "cRF_RData", "cf_600_Hill2_total_2026-03-12.RData"))
...
"stats_training_Hill2_total_600_2026-03-12.xlsx"))
...
pred_RMSE_600 <- round(sqrt(mean((pred_600-test_r600$butterfly.Hill2.total)**2)),2)
pred_RMSE_600
# 2.24
pred_R2_600 <- round(cor(pred_600, test_r600$butterfly.Hill2.total)**2,2)
pred_R2_600
# 0.15
...
#          value = round(value, 2))
# imp_r600 %>% write.xlsx(here("outputs", "tables", "imp_r600_Hill2_total.xlsx"))
