#+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
# GRASSWORKS Project 
# Analyses of restoration method - total abundance
#+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
# author: Line Sturm
# 13 June 2026
...
## 1 glm.RM ####
glm.RM <- glm(butterfly.abu ~ region + obs.year
...
## 2 glm.RMa ####
glm.RMa <- glm(butterfly.abu ~ region + obs.year
              + rest.meth + site.cwm.pres.oek.f ,
              data = data, family = "poisson")
summary(glm.RMa)
...
## 3 glm.RMa_nb ####
glm.RMa_nb <- glm.nb(butterfly.abu ~ region + obs.year
               + rest.meth + site.cwm.pres.oek.f ,
               data = data)
...
# data:  glm.RMa_nb
# observed = -0.0322203, expected = -0.0083333, sd = 0.0277555, p-value = 0.3894
...
# R2m       R2c
# delta     0.3597510 0.3597510
# lognormal 0.4023804 0.4023804
# trigamma  0.3119696 0.3119696
...
dat_pred2 %>% write.csv(file = here::here("outputs", "tables", 
                                          "EMM1_RM_abu_tot.csv"), row.names = F)
